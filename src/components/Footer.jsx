          ...
          <div className={Style.row}>
            <div className={`${Style.col} ${Style.col1}`}>
              ...
              <p>
                ...
                paneles solares. Contamos con una amplia gama de los mismos.
              </p>
            ...
            <div className={`${Style.col} ${Style.col2}`}>
              ...
              <Link onClick={(e) => upPage(e, '/')}>Inicio</Link>
              <Link onClick={(e) => upPage(e, '/about')}>Acerca de</Link>
              <Link onClick={(e) => upPage(e, '/products')}>Productos</Link>
              {/* <Link onClick={upPage}>Contacto</Link> */}
            </div>
