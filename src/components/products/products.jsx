    ...
    <div>
        ...
        <div className={Style.containerSectionInfo}>
            ...
            <div className={Style.izquierda}>
                <img src="https://images.pexels.com/photos/8853537/pexels-photo-8853537.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="img-panelSolar" className={Style.SectionInfoImg}/>                             
            ...
            <div className={Style.derecha}>
                <div className={Style.containerText}>
                    ...
                    <button>Comprar ahora <i class="fa-solid fa-arrow-down"></i></button>
                </div>
            </div>           
