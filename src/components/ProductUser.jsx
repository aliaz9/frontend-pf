...
export default function ProductUser() {
  ...
  //     image:
  //       'https://ecoinventos.com/wp-content/uploads/2018/02/Tipos-de-panel-solar.jpg',
  ...
  //     brandName: 'CdTe',
  //     image:
  //       'https://cdn.computerhoy.com/sites/navi.axelspringer.es/public/media/image/2021/11/paneles-solares-2525685.jpg?tf=3840x',
            ...
            return (
              ...
              <div className={styles['conteiner-main']}>
                <div className={styles['conteiner-title']}>
                  <img src={b.image} width={200} alt="imagen del producto" />
                </div>
                <div className={styles['main-description']}>
                  ...
                  <small>
                    ...
                    <Link to={`/product/${b.ProductId}`}>
                      <small className={styles['main-link']}>
                        &nbsp;<i className="fa-solid fa-circle-info"></i> Ver
                        Detalle
                      </small>
                    </Link>
                  </small>
