                ...
                <div className={styles['conteiner-main']}>
                  ...
                  : (
                    <div className={styles['not-products']}>
                        <img className={styles['not-products-img']} src="images/not-productos.png" width={400} alt="" />
                        <b className={styles['not-products-title']}>Aun no ha realizado compras en nuestra plataforma</b>
                    </div>
                    )
            }
        </div>
