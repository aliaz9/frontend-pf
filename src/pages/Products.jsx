    ...
    <div className={styles.container}>
      ...
      <div className={styles.newsLatterContainer}>
        <div className={styles.newsLatter}>
          ...
          <p className={styles.p}>Entérate primero de nuestras promociones y recibe descuentos por mail.</p>
          ...
          <input type="text" id="name" placeholder='Ingresa tu Email' className={styles.input}></input>
          <button type="submit" className={styles.buttonsubmit}><i class="fa-solid fa-paper-plane paperplane" ></i></button>
