    ...
    <>
        ...
        <div className={styles.containerH1}>
          <div className={styles.containerText}>
            ...
            <h4 className={styles.h4}>
              Puedes ahorrar dinero invirtiendo en energía solar.
            </h4>
            ...
            <p className={styles.p}>
              Tenemos todo lo que necesitas para sumarte a este cambio.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.Info}>
        ...
        <div className={styles.boxInfoIMGcontainer}>
          <img
            className={styles.boxInfoIMG}
            src="https://res.cloudinary.com/daieynebb/image/upload/v1678139914/FlatIcon/la-temperatura_ab3q3h.png"
          ></img>
        </div>
        ...
        <div className={styles.boxInfoIMGcontainer}>
          <img
            className={styles.boxInfoIMG}
            src="https://res.cloudinary.com/daieynebb/image/upload/v1678141204/FlatIcon/energia_kxvpqi.png"
          ></img>
        </div>
        ...
        <div className={styles.boxInfoIMGcontainer}>
          <img
            className={styles.boxInfoIMG}
            src="https://res.cloudinary.com/daieynebb/image/upload/v1678141342/FlatIcon/sin-botellas-de-plastico_olx6yj.png"
          ></img>
        </div>
        ...
        <div className={styles.boxInfoIMGcontainer}>
          <img
            className={styles.boxInfoIMG}
            src="https://res.cloudinary.com/daieynebb/image/upload/v1678141502/FlatIcon/energia-solar_zdjmmh.png"
          ></img>
        </div>
        ...
        <div className={styles.boxInfo}>
          ...
          <p>
            Hoy las renovables, son más baratas que las energías convencionales
            en buena parte del mundo. Están reduciendo drásticamente sus costes,
            de forma que ya son plenamente competitivas con las convencionales.
            Las economías de escala y la innovación están ya consiguiendo que
            las energías renovables lleguen a ser la solución más sostenible, no
            sólo ambiental sino también económicamente, para mover el mundo.
          </p>
        </div>
      </div>
      <div className={styles.boxButton}>
        <a href="#top">
          <button className={styles.button1} href="#top">
            Ir hacia arriba <i className="fa-solid fa-arrow-up"></i>
          </button>
        </a>
      </div>
    </>
